...
function Nav() {
    return (
        <div className='box-border border-b py-4 border-bordercolor select-none'>
            <div className='box-border px-5 mx-auto min-h-70 flex items-center max-w-6xl justify-between '>
                <div>
                    <img src={printImage} />
                </div>
                <div className='flex items-center '>
                    <div className='hidden middle:block mr-6'>
                        <ul className='flex items-center uppercase'>
                            ...
                            <li className=' group relative px-5 '>
                                <button className="flex  rounded uppercase  hover:text-primary">
                                    <span>Account</span>
                                    <RiArrowDropDownLine className="text-2xl" />
                                </button>
                                <nav tabindex="0" className=" border border-gray-200 bg-white invisible  rounded w-60 absolute left-0 top-full transition-all opacity-0 group-focus-within:visible group-focus-within:opacity-100 group-focus-within:translate-y-1 ">
                                    <ul className="py-1">
                                        <li>
